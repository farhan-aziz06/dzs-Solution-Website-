      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center gap-10 
                          min-[1031px]:flex-row min-[1031px]:items-start min-[1031px]:text-left min-[1031px]:gap-0">
            {/* Logo and social media icons */}
            <div className="mb-6 min-[1031px]:mb-0 min-[1031px]:mt-4 min-[1031px]:ml-60">
            ...
            <div className="hidden min-[1031px]:flex flex-1"></div>

            {/* Links sections */}
            <div className="flex flex-col gap-8 items-center
                            min-[1031px]:flex-row min-[1031px]:gap-32 min-[1031px]:mr-64 min-[1031px]:items-start">
              {/* Useful Links */}
              <div>
