          ...
          <div className="flex flex-col items-center text-center gap-10 
            ...
            <div className="mb-6 min-[768px]:mb-0 min-[768px]:mt-4 min-[1031px]:ml-60">
              <div className="flex flex-col items-center space-y-4 mb-6">
                ...
                {/* Social media icons - two rows on small screens, single row on large screens */}
                <div className="flex flex-col gap-2 min-[768px]:flex-row min-[768px]:gap-4">
                  {/* First row on small screens */}
