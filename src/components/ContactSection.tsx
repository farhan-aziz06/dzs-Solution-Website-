...
">
            ...
            {/* Left - Image */}
            <div
              className={`flex items-center justify-center lg:justify-start h-full transform transition-all duration-1000 ease-out ${
            ...
            {/* Right - Form */}
            <div
              className={`h-full flex flex-col justify-center items-center lg:items-start space-y-2 sm:space-y-3 lg:space-y-4 w-full transform transition-all duration-1000 ease-out
              ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center gap-4 pt-2 w-full lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <a href="#" className="hover:opacity-80 transition-all duration-300 hover:scale-110">
                    <img src="/discord.svg" alt="Discord" className="w-7 sm:h-8 h-7 sm:h-8" />
                  </a>
                </div>
              </div>
            </div>
