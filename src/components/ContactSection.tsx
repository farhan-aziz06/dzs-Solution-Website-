...
const ContactSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 px-6 bg-white mb-24">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Main Content Grid - Consistent responsive layout */}
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-6 w-full max-w-md mx-auto lg:mx-0 lg:max-w-none transform transition-all duration-1000 ease-out ${
            isVisible ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'
          }`} style={{ transitionDelay: '200ms' }}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-base"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <input 
                  type="tel" 
                  placeholder="Phone" 
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-base"
                />
              </div>
            </div>
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                {projectTypes.map((project) => (
                  <button
                    ...
                    className={`
                      px-6 py-3 rounded-full text-sm transition-all duration-300 whitespace-nowrap
            ...
            <div>
              <textarea 
                ...
                className="w-full h-12 px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none overflow-hidden transition-all duration-300 text-base"
              ></textarea>
            </div>

            {/* Submit Button and Social Icons */}
            <div className="flex items-center justify-between gap-4">
              <button className="relative overflow-hidden bg-gradient-to-r from-purple-500 to-purple-400 hover:from-purple-600 hover:to-purple-500 text-white px-8 py-3 rounded-full transition-all duration-300 flex items-center gap-2 hover:scale-105 hover:shadow-lg text-base font-normal group">
