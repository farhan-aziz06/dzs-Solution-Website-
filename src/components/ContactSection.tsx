...
">
            ...
            {/* Left - Image - Made wider on mobile */}
            <div
            ...
            {/* Right - Form - Made narrower on mobile */}
            <div
              className={`h-full flex flex-col justify-center items-center xl:items-start space-y-2 sm:space-y-3 xl:space-y-4 w-full max-w-[320px] sm:max-w-[400px] xl:max-w-full mx-auto xl:mx-0 transform transition-all duration-1000 ease-out
              ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}
            ...
            >
              ...
              {/* Submit & Social - Centered on mobile */}
