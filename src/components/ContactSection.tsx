  ...
  return (
    <section ref={sectionRef} className="pt-8 sm:pt-12 lg:pt-16 pb-6 sm:pb-8 lg:pb-12 px-3 sm:px-4 lg:px-6 bg-white mb-12 sm:mb-18 lg:mb-24">
      <div className="max-w-6xl mx-auto">
        {/* Header Section - Slides from Left with mobile-optimized spacing */}
        <div className={`mb-4 sm:mb-6 lg:mb-8 transform transition-all duration-1000 ease-out ${
        ...
        {/* Main Content Grid - Mobile-optimized responsive layout */}
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          {/* Left Side - Contact Image - Mobile-responsive sizing */}
          ...
          {/* Right Side - Contact Form - Mobile-optimized spacing and sizing */}
          <div className={`space-y-3 sm:space-y-4 lg:space-y-6 mt-4 sm:mt-6 lg:mt-16 max-w-md sm:max-w-none mx-auto lg:mx-0 transform transition-all duration-1000 ease-out ${
            ...
            {/* Name Fields - Mobile-responsive spacing */}
            ...
            {/* Email Field - Mobile-responsive sizing */}
            <div>
            ...
            {/* Phone Field - Mobile-responsive layout */}
            <div>
            ...
            {/* Project Type - Mobile-responsive buttons */}
            <div>
            ...
            {/* Message Field - Mobile-responsive sizing */}
            <div>
              <textarea 
            ...
            {/* Submit Button and Social Icons - Mobile-responsive layout */}
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
              ...
              {/* Social Icons - Mobile-responsive sizing */}
