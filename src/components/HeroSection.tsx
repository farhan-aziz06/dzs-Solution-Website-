    ...
    <section className="relative bg-white min-h-screen px-6 py-9">
      ...
      <div className="max-w-7xl mx-auto px-6 py-46 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh] pt-40">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div
              className={`reviews-card bg-white rounded-3xl p-2.5 w-full max-w-[400px] mt-8 lg:mt-0 lg:absolute lg:w-[400px] lg:bottom-[-195px] lg:right-[-20px] transform transition-all duration-1000 ease-out ${
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          /* Center the reviews card container on mobile */
          .relative.flex.justify-center.lg\\:justify-end {
            justify-content: center !important;
          }
        }
        
        /* Tablets - adjust positioning to fit screen */
        ...
        /* Large screens - ensure proper fit and positioning */
        ...
        /* Extra large screens - prevent overflow */
