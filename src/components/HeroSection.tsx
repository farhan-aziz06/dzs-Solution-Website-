    ...
    <section className="relative overflow-hidden bg-white min-h-screen px-6 py-9">
      ...
      <div className="max-w-7xl mx-auto px-6 py-46 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh] pt-40">
          ...
          {/* Right side - Reviews card with responsive positioning */}
          <div className="relative flex justify-center lg:justify-end">
            {/* Mobile: centered and below content, Desktop: positioned absolutely */}
            <div
                 style={{
                   boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
                 }}
                 className="bg-white rounded-3xl p-2.5 w-full max-w-[400px] mt-8 lg:mt-0 lg:absolute lg:w-[400px] lg:bottom-[-195px] lg:right-[-20px]">
