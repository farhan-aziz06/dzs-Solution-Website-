...
<div className="px-1 sm:px-2">
  <div className="flex items-center justify-between mb-2 sm:mb-3">
    <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap">
      <span
        className={`px-2 sm:px-3 lg:px-4 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs lg:text-sm font-medium shadow-lg transition-all duration-300 bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 text-white group-hover:from-purple-600 group-hover:via-purple-500 group-hover:to-purple-600 relative overflow-hidden`}
      >
      ...
      <span className="text-gray-900 text-[10px] sm:text-xs lg:text-sm font-medium hidden sm:block">
        AI Integrated Workflow Product
      </span>
      <span className="text-gray-900 text-[10px] sm:text-xs lg:text-sm font-medium block sm:hidden">
        AI Product
      </span>
    </div>
    ...
    <div className="relative flex items-center">
      <div className="relative overflow-hidden border border-gray-200 bg-gray-100 rounded-full transition-all duration-500 ease-out group-hover:pr-10 sm:group-hover:pr-12 lg:group-hover:pr-14">
        <div className="px-1 sm:px-2 lg:px-3 py-0.5 sm:py-1 transition-all duration-500 ease-out">
          <span className="text-gray-500 text-[10px] sm:text-xs lg:text-sm whitespace-nowrap">by Team</span>
        </div>
      </div>
      <div className="absolute right-1 flex -space-x-1 sm:-space-x-1.5 transition-all duration-500 ease-out transform translate-x-5 sm:translate-x-6 opacity-0 group-hover:translate-x-0 group-hover:opacity-100">
        {project.team.map((member, i) => (
          <div
            key={i}
            className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 rounded-full overflow-hidden transition-all duration-300 shadow-sm"
